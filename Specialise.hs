...
simulate'IOChain'StandardScore'PDB'MWCIO :: E.RunSettings IOChainRepresentation StandardScore PDBBackend -> Dump -> MWCIO Dump
simulate'IOChain'StandardScore'PDB'MWCIO = inline E.simulate
{-# NOINLINE simulate'IOChain'StandardScore'PDB'MWCIO #-}

simulate'IOChain'StandardScore'Bin'MWCIO :: E.RunSettings IOChainRepresentation StandardScore BinaryBackend -> Dump -> MWCIO Dump
