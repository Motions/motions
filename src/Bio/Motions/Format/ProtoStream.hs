...
foreign import ccall unsafe "protostream_open_existing"
    protoOpenExisting :: CString -> IO (Ptr HStream)

foreign import ccall unsafe "protostream_open_new"
...
foreign import ccall unsafe "protostream_append_delta"
    protoAppendDelta :: Ptr HStream -> Ptr () -> CSize -> IO ()

foreign import ccall unsafe "protostream_get_header"
    protoGetHeader :: Ptr HStream -> Ptr (Ptr ()) -> Ptr CSize -> IO ()

foreign import ccall unsafe "protostream_free_header"
    protoFreeHeader :: Ptr () -> IO ()

foreign import ccall unsafe "protostream_iter_keyframes"
    protoIterKeyframes :: Ptr HStream -> IO (Ptr HKeyframeIterator)

foreign import ccall unsafe "protostream_get_keyframe"
    protoGetKeyframe :: Ptr HKeyframeIterator -> Ptr (Ptr ()) -> Ptr CSize -> IO ()

foreign import ccall unsafe "protostream_free_keyframe"
    protoFreeKeyframe :: Ptr () -> IO ()

foreign import ccall unsafe "protostream_valid_keyframe_iterator"
...
foreign import ccall unsafe "protostream_iter_deltas"
    protoIterDeltas :: Ptr HKeyframeIterator -> IO (Ptr HDeltaIterator)

foreign import ccall unsafe "protostream_get_delta"
    protoGetDelta :: Ptr HDeltaIterator -> Ptr (Ptr ()) -> Ptr CSize -> IO ()

foreign import ccall unsafe "protostream_free_delta"
    protoFreeDelta :: Ptr () -> IO ()

foreign import ccall unsafe "protostream_valid_delta_iterator"
    protoValidDeltaIterator :: Ptr HKeyframeIterator -> Ptr HDeltaIterator -> IO CInt

foreign import ccall unsafe "protostream_advance_delta_iterator"
    protoAdvanceDeltaIterator :: Ptr HDeltaIterator -> IO ()

foreign import ccall unsafe "protostream_free_delta_iterator"
