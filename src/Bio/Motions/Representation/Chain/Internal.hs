...
-- |Checks if there is a chain between two given points. Assumes that the quadrance
--  of the distance between these points equals to 1 or 2, i. e. they are neighbours
--  on the 3-dimensional grid.
