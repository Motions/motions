...
runSimulation SimulationSettings{..} dump
    ...
    | "IOChain" <- reprName,
      "StandardScore" <- scoreName =
        runMWCIO (E.simulate (mkRunSettings runSettings :: E.RunSettings IOChainRepresentation StandardScore) dump)
    | "PureChain" <- reprName,
      "StandardScore" <- scoreName =
        runMWCIO (E.simulate (mkRunSettings runSettings :: E.RunSettings PureChainRepresentation StandardScore) dump)
