...
{-# SPECIALISE E.simulate :: E.RunSettings IOChainRepresentation StandardScore PDBBackend -> Dump -> MWCIO Dump #-}
{-# SPECIALISE E.simulate :: E.RunSettings IOChainRepresentation StandardScore BinaryBackend -> Dump -> MWCIO Dump #-}
