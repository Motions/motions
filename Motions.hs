...
runSimulation Settings{..}
    ...
    | "IOChain" <- reprName,
      "StandardScore" <- scoreName =
        runMWCIO . E.simulate (mkRunSettings runSettings :: E.RunSettings IOChainRepresentation StandardScore)
    | "PureChain" <- reprName,
      "StandardScore" <- scoreName =
        runMWCIO . E.simulate (mkRunSettings runSettings :: E.RunSettings PureChainRepresentation StandardScore)
